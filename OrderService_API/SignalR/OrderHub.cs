...
namespace OrderService_API.SignalR
{
    public class OrderHub : Hub
    {
        ...
        public OrderHub(ICacheService cacheService, IOrderRepository orderRepository, IRabbitMQSender rabbitMQSender,
            ILogger<OrderHub> logger, IMapper mapper, IOrderTypeProcessor orderTypeProcessor)
        {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            if (string.IsNullOrWhiteSpace(productId) || string.IsNullOrEmpty(paymentMethodId) || !isParsedOrder) throw new HubException("Please provide valid data");
            ...
            var orderData = new CreateOrderData(productId, userId, coupon, userEmail, order, gameId, paymentMethodId);
