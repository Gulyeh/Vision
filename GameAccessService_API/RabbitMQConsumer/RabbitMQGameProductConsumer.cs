...
{
    public class RabbitMQGameProductConsumer  : BackgroundService
    {
        private readonly ILogger<RabbitMQGameProductConsumer> logger;
        private readonly IServiceScopeFactory scopeFactory;
        private readonly IRabbitMQSender rabbitMQSender;
        private IConnection connection;
        private IModel channel;

        public RabbitMQGameProductConsumer (IOptions<RabbitMQSettings> options, ILogger<RabbitMQGameProductConsumer> logger, IServiceScopeFactory scopeFactory, IRabbitMQSender rabbitMQSender)
        {
            this.logger = logger;
